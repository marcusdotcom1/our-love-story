...
const CARDS = [
  { title: "morning", grad: "from-[oklch(0.92_0.06_25)] to-[oklch(0.82_0.09_80)]", depth: 0 },
  { title: "laughter", grad: "from-[oklch(0.94_0.04_60)] to-[oklch(0.85_0.08_20)]", depth: 1 },
  { title: "adventures", grad: "from-[oklch(0.9_0.05_300)] to-[oklch(0.88_0.06_25)]", depth: 2 },
  { title: "quiet nights", grad: "from-[oklch(0.88_0.07_25)] to-[oklch(0.75_0.1_15)]", depth: 3 },
  { title: "always", grad: "from-[oklch(0.95_0.03_85)] to-[oklch(0.85_0.08_15)]", depth: 4 },
];
...
function FloatCard({
  ...
  const y = useTransform(progress, [0, 1], [200 + card.depth * 120, -400 - card.depth * 60]);
  ...
  return (
    <motion.div
      ...
      data-cursor="❤️"
    >
      <div className="relative h-full w-full rounded-md bg-black/5 ring-1 ring-white/40">
        <p className="absolute bottom-4 left-4 font-script text-2xl text-white/80 drop-shadow">{card.title}</p>
      </div>
    </motion.div>
  );
}
...
export function FloatingMemories() {
  ...
  return (
    <section ref={ref} className="relative h-[220vh] overflow-hidden bg-[oklch(0.94_0.03_25)]">
